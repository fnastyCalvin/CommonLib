 ...
 * <li>{@link PackageUtil#installNormal(android.content.Context, String)}</li>
 * <li>{@link PackageUtil#installSilent(android.content.Context, String)}</li>
 * <li>{@link PackageUtil#install(android.content.Context, String)}</li>
 * </ul>
 * <ul>
 * <strong>Uninstall package</strong>
 * <li>{@link PackageUtil#uninstallNormal(android.content.Context, String)}</li>
 * <li>{@link PackageUtil#uninstallSilent(android.content.Context, String)}</li>
 * <li>{@link PackageUtil#uninstall(android.content.Context, String)}</li>
 * </ul>
 * <ul>
 * <strong>Is system application</strong>
 * <li>{@link PackageUtil#isSystemApplication(android.content.Context)}</li>
 * <li>{@link PackageUtil#isSystemApplication(android.content.Context, String)}</li>
 * <li>{@link PackageUtil#isSystemApplication(android.content.pm.PackageManager, String)}</li>
 * </ul>
 * <ul>
 * <strong>Others</strong>
 * <li>{@link PackageUtil#getInstallLocation()} get system install location</li>
 * <li>{@link PackageUtil#isTopActivity(android.content.Context, String)} whether the app whost package's name is packageName is on the
 * top of the stack</li>
 * <li>{@link PackageUtil#startInstalledAppDetails(android.content.Context, String)} start InstalledAppDetails Activity</li>
 * </ul>
 * 
...
public class PackageUtil {
     ...
     *         {@link PackageUtil}.INSTALL_FAILED_*. same to {@link android.content.pm.PackageManager}.INSTALL_*
