...
public class ResourceUtil {
    ...
    /**
     * find ResourceId in R file
     * @param context
     * @param fileName  eg. ic_lancher
     * @param type  drawable    color   string eg. resource file name
     * @return
     */
    public static int getResourceId(Context context,String fileName,String type){
        if (context == null || TextUtils.isEmpty(fileName) || TextUtils.isEmpty(fileName)) {
            return 0;
        }
        int resId = 0;
        ApplicationInfo appInfo = context.getApplicationInfo();
        try {
            resId = context.getResources().getIdentifier(fileName, type, appInfo.packageName);
        }
        catch (Exception e){
            e.printStackTrace();
            resId = 0;
