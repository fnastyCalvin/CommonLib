 ...
 * <li>{@link ViewUtil#getListViewHeightBasedOnChildren(android.widget.ListView)}</li>
 * <li>{@link ViewUtil#getAbsListViewHeightBasedOnChildren(android.widget.AbsListView)}</li>
 * </ul>
 * <ul>
 * <strong>set view height</strong>
 * <li>{@link ViewUtil#setViewHeight(android.view.View, int)} set view height</li>
 * <li>{@link ViewUtil#setListViewHeightBasedOnChildren(android.widget.ListView)}</li>
 * <li>{@link ViewUtil#setAbsListViewHeightBasedOnChildren(android.widget.AbsListView)}</li>
 * </ul>
 * <ul>
 * <strong>get other info</strong>
 * <li>{@link ViewUtil#getGridViewVerticalSpacing(android.widget.GridView)} get GridView vertical spacing</li>
 * </ul>
 * <ul>
 * <strong>set other info</strong>
 * <li>{@link ViewUtil#setSearchViewOnClickListener(android.view.View, android.view.View.OnClickListener)}</li>
 * </ul>
 * 
